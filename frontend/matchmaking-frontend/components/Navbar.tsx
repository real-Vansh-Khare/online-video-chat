    ...
    return (
        ...
        <div className="flex justify-between bg-purple-900 text-white px-4 text-xl">
            ...
            <div className="my-4">
                ...
                <Link href="/" className="max-md:hidden bg-purple-700 p-2 border rounded-full hover:bg-purple-950 hover:text-purple-200">Signup</Link>
            </div>
        </div>
        <MobileNavbar />
        </>
    ...
    return (
        ...
        <div className="bg-gray-300 h-screen hidden peer-checked:block fixed bottom-0 right-0 left-0 top-16 z-10">
            <div className="flex flex-col justify-start">
                ...
                <Link href="/" className="text-center text-2xl font-medium py-6 hover:bg-purple-400 hover:text-purple-900">Connect</Link>
                <Link href="/" className="text-center text-2xl font-medium py-6 hover:bg-purple-400 hover:text-purple-900">Login</Link>
                <Link href="/" className="text-center text-2xl font-medium py-6 hover:bg-purple-400 hover:text-purple-900">Signup</Link>
            </div>
        </div>
        </>
    )
